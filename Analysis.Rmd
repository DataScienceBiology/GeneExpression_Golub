...
As we see the distribution looks squished. Now, we transpose the data and try some normalization. We'll also select the 100 most variable genes through samples. 
